...
import (
	...
	"github.com/onosproject/onos-exporter/pkg/internal/binutils"
	"github.com/onosproject/onos-exporter/pkg/internal/plugin"
	"github.com/onosproject/onos-exporter/pkg/internal/symbolizer"
	"github.com/onosproject/onos-exporter/pkg/internal/transport"
)
...
func SetDefaults(o *plugin.Options) *plugin.Options {
	...
	if d.HTTPTransport == nil {
		d.HTTPTransport = transport.New(nil)
	}
	if d.Sym == nil {
